...
// Class-flavored attack range (squared, in world units). Mages cast from afar
// instead of meleeing — both client (auto-walk-to-target) and server
// (out-of-range cap) read these so they stay in lockstep.
const ATTACK_RANGE = {
  warrior: 3.0,
  mage:    8.0,
};
const ATTACK_RANGE_SQ = {
  warrior: ATTACK_RANGE.warrior * ATTACK_RANGE.warrior,
  mage:    ATTACK_RANGE.mage    * ATTACK_RANGE.mage,
};

module.exports = { ITEMS, MOBS, WORLD, STARTER, ATTACK_RANGE, ATTACK_RANGE_SQ, xpForLevel, statsForLevel };
